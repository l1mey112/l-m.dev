...
- Long time experience with open source, linux, devops, and the like.
...
* [(+)](https://github.com/l1mey112/experimental_compiler2) [\[Yt\]](https://www.youtube.com/playlist?list=PLqQJmxnx9qYUBozZQIcgrqYBgKYK9h2Fl) **Compiler in C, web series** | Module system, unified function call syntax, compile time evaluation, type inference and basic unification.
- [(+)](https://github.com/l1mey112/me.l-m.dev) **'me.l-m.dev'** | A stylistically minimal, privacy respecting, linear blogging website, written in the V programming language. A search engine for me, the things I am interested with, and take part in.
