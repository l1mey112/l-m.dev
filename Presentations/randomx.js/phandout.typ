...
#set document(
  title: [Zero to RandomX.js: Bringing Webmining Back From The Grave],
  author: "Liam Leadbetter",
  keywords: (
    "RandomX", "WebAssembly", "Monero", "proof of work", "webmining",
    "JavaScript", "IEEE 754", "floating point", "error-free transforms",
    "cryptography", "C programming", "XMR", "RandomX.js", "JIT", "compiler",
  ),
...
#slide(title: "About me")[
  #grid(columns: (10fr, 6fr), gutter: 2em, gc[
    ...
    - These slides: #underline[https://l-m.dev/talk]
...
#slide(title: [(1.RX) RandomX])[
  ...
  *Defn.*  #strong()[_A_]pplication-#strong()[_S_]pecific-#strong()[_I_]ntegrated-#strong()[_C_]ircuit --- ASIC are specialised circuits.
]
