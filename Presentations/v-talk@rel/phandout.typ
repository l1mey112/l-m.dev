...
#set document(
  title: [Read Fast, Write Fast, And Run Faster: How To Maintain And Iterate With V],
  author: "Liam Leadbetter",
  keywords: (
    "V", "vlang", "V programming language", "WebAssembly", "WASM",
    "compiler backend", "code generation", "standard library",
    "programming language design", "SYNCS", "compiler",
  ),
